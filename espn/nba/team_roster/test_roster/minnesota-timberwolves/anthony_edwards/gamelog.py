...
# Base directory
BASE_DIR = "/Users/kamahl/Sports/scripts_espn/nba/team_roster/nba_team_rosters/nba_teams"
os.makedirs(BASE_DIR, exist_ok=True)

# Player-specific variables (example for Anthony Edwards)
player_id = "4594268"
...
def fetch_and_save_gamelog():
    ...
    # Save to CSV
    player_folder = os.path.join(BASE_DIR, team, player_name.lower().replace(" ", "_"))
