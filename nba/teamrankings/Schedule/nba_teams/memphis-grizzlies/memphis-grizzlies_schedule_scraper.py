...
BASE_DIR = "/Users/kamahl/Sports/scripts/nba/teamrankings/Schedule/nba_teams/memphis-grizzlies"
os.makedirs(BASE_DIR, exist_ok=True)

def fetch_and_save_memphis_grizzlies_schedule():
    """Fetch and save the Memphis Grizzlies schedule from TeamRankings."""
    url = "https://www.teamrankings.com/nba/team/memphis-grizzlies"
    
    print(f"Fetching schedule for Memphis Grizzlies from {url}")
    ...
    # Save to CSV
    csv_filename = os.path.join(BASE_DIR, "memphis-grizzlies_schedule_results.csv")
    df.to_csv(csv_filename, index=False)
    print(f"CSV file saved: {csv_filename}")
    
    # Save to Excel
    excel_filename = os.path.join(BASE_DIR, "memphis-grizzlies_schedule_results.xlsx")
...
if __name__ == "__main__":
    fetch_and_save_memphis_grizzlies_schedule()