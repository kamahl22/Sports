...
BASE_DIR = "/Users/kamahl/Sports/scripts/nba/teamrankings/players/player_stats/nba_teams/phoenix-suns/bol-bol"
...
def fetch_and_save_bol_bol_stats():
    """Fetch and save stats for Bol Bol from TeamRankings."""
    player_name = "Bol Bol"
    formatted_name = "bol-bol"
    ...
    basic_csv_filename = os.path.join(BASE_DIR, "bol-bol_basic_stats.csv")
    basic_df.to_csv(basic_csv_filename, index=False)
    print(f"Basic Stats CSV file saved: {basic_csv_filename}")
    
    basic_excel_filename = os.path.join(BASE_DIR, "bol-bol_basic_stats.xlsx")
    ...
    ranking_csv_filename = os.path.join(BASE_DIR, "bol-bol_ranking_stats.csv")
    ranking_df.to_csv(ranking_csv_filename, index=False)
    print(f"Ranking Stats CSV file saved: {ranking_csv_filename}")
    
    ranking_excel_filename = os.path.join(BASE_DIR, "bol-bol_ranking_stats.xlsx")
