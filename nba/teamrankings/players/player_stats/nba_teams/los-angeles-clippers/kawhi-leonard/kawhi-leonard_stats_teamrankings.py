...
BASE_DIR = "/Users/kamahl/Sports/scripts/nba/teamrankings/players/player_stats/nba_teams/los-angeles-clippers/kawhi-leonard"
...
def fetch_and_save_kawhi_leonard_stats():
    """Fetch and save stats for Kawhi Leonard from TeamRankings."""
    player_name = "Kawhi Leonard"
    formatted_name = "kawhi-leonard"
    ...
    basic_csv_filename = os.path.join(BASE_DIR, "kawhi-leonard_basic_stats.csv")
    basic_df.to_csv(basic_csv_filename, index=False)
    print(f"Basic Stats CSV file saved: {basic_csv_filename}")
    
    basic_excel_filename = os.path.join(BASE_DIR, "kawhi-leonard_basic_stats.xlsx")
    ...
    ranking_csv_filename = os.path.join(BASE_DIR, "kawhi-leonard_ranking_stats.csv")
    ranking_df.to_csv(ranking_csv_filename, index=False)
    print(f"Ranking Stats CSV file saved: {ranking_csv_filename}")
    
    ranking_excel_filename = os.path.join(BASE_DIR, "kawhi-leonard_ranking_stats.xlsx")
...
if __name__ == "__main__":
    fetch_and_save_kawhi_leonard_stats()