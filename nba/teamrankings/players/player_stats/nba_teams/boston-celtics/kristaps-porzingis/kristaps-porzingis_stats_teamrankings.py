...
BASE_DIR = "/Users/kamahl/Sports/scripts/nba/teamrankings/players/player_stats/nba_teams/boston-celtics/kristaps-porzingis"
...
def fetch_and_save_kristaps_porzingis_stats():
    """Fetch and save stats for Kristaps Porzingis from TeamRankings."""
    player_name = "Kristaps Porzingis"
    formatted_name = "kristaps-porzingis"
    ...
    basic_csv_filename = os.path.join(BASE_DIR, "kristaps-porzingis_basic_stats.csv")
    basic_df.to_csv(basic_csv_filename, index=False)
    print(f"Basic Stats CSV file saved: {basic_csv_filename}")
    
    basic_excel_filename = os.path.join(BASE_DIR, "kristaps-porzingis_basic_stats.xlsx")
    ...
    ranking_csv_filename = os.path.join(BASE_DIR, "kristaps-porzingis_ranking_stats.csv")
    ranking_df.to_csv(ranking_csv_filename, index=False)
    print(f"Ranking Stats CSV file saved: {ranking_csv_filename}")
    
    ranking_excel_filename = os.path.join(BASE_DIR, "kristaps-porzingis_ranking_stats.xlsx")
...
if __name__ == "__main__":
    fetch_and_save_kristaps_porzingis_stats()