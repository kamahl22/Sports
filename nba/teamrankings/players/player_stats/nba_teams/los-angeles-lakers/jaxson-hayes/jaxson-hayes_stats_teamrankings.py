...
BASE_DIR = "/Users/kamahl/Sports/scripts/nba/teamrankings/players/player_stats/nba_teams/los-angeles-lakers/jaxson-hayes"
...
def fetch_and_save_jaxson_hayes_stats():
    """Fetch and save stats for Jaxson Hayes from TeamRankings."""
    player_name = "Jaxson Hayes"
    formatted_name = "jaxson-hayes"
    ...
    basic_csv_filename = os.path.join(BASE_DIR, "jaxson-hayes_basic_stats.csv")
    basic_df.to_csv(basic_csv_filename, index=False)
    print(f"Basic Stats CSV file saved: {basic_csv_filename}")
    
    basic_excel_filename = os.path.join(BASE_DIR, "jaxson-hayes_basic_stats.xlsx")
    ...
    ranking_csv_filename = os.path.join(BASE_DIR, "jaxson-hayes_ranking_stats.csv")
    ranking_df.to_csv(ranking_csv_filename, index=False)
    print(f"Ranking Stats CSV file saved: {ranking_csv_filename}")
    
    ranking_excel_filename = os.path.join(BASE_DIR, "jaxson-hayes_ranking_stats.xlsx")
...
if __name__ == "__main__":
    fetch_and_save_jaxson_hayes_stats()