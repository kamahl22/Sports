...
BASE_DIR = "/Users/kamahl/Sports/scripts/nba/teamrankings/players/player_stats/nba_teams/toronto-raptors/eugene-omoruyi"
...
def fetch_and_save_eugene_omoruyi_stats():
    """Fetch and save stats for Eugene Omoruyi from TeamRankings."""
    player_name = "Eugene Omoruyi"
    formatted_name = "eugene-omoruyi"
    ...
    basic_csv_filename = os.path.join(BASE_DIR, "eugene-omoruyi_basic_stats.csv")
    basic_df.to_csv(basic_csv_filename, index=False)
    print(f"Basic Stats CSV file saved: {basic_csv_filename}")
    
    basic_excel_filename = os.path.join(BASE_DIR, "eugene-omoruyi_basic_stats.xlsx")
    ...
    ranking_csv_filename = os.path.join(BASE_DIR, "eugene-omoruyi_ranking_stats.csv")
    ranking_df.to_csv(ranking_csv_filename, index=False)
    print(f"Ranking Stats CSV file saved: {ranking_csv_filename}")
    
    ranking_excel_filename = os.path.join(BASE_DIR, "eugene-omoruyi_ranking_stats.xlsx")
...
if __name__ == "__main__":
    fetch_and_save_eugene_omoruyi_stats()