...
BASE_DIR = "/Users/kamahl/Sports/scripts/nba/teamrankings/players/player_stats/nba_teams/orlando-magic/cory-joseph"
...
def fetch_and_save_cory_joseph_stats():
    """Fetch and save stats for Cory Joseph from TeamRankings."""
    player_name = "Cory Joseph"
    formatted_name = "cory-joseph"
    ...
    basic_csv_filename = os.path.join(BASE_DIR, "cory-joseph_basic_stats.csv")
    basic_df.to_csv(basic_csv_filename, index=False)
    print(f"Basic Stats CSV file saved: {basic_csv_filename}")
    
    basic_excel_filename = os.path.join(BASE_DIR, "cory-joseph_basic_stats.xlsx")
    ...
    ranking_csv_filename = os.path.join(BASE_DIR, "cory-joseph_ranking_stats.csv")
    ranking_df.to_csv(ranking_csv_filename, index=False)
    print(f"Ranking Stats CSV file saved: {ranking_csv_filename}")
    
    ranking_excel_filename = os.path.join(BASE_DIR, "cory-joseph_ranking_stats.xlsx")
...
if __name__ == "__main__":
    fetch_and_save_cory_joseph_stats()