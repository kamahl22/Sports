...
BASE_DIR = "/Users/kamahl/Sports/scripts/nba/teamrankings/players/player_stats/nba_teams/milwaukee-bucks/aj-green"
...
def fetch_and_save_aj_green_stats():
    """Fetch and save stats for AJ Green from TeamRankings."""
    player_name = "AJ Green"
    formatted_name = "aj-green"
    ...
    basic_csv_filename = os.path.join(BASE_DIR, "aj-green_basic_stats.csv")
    basic_df.to_csv(basic_csv_filename, index=False)
    print(f"Basic Stats CSV file saved: {basic_csv_filename}")
    
    basic_excel_filename = os.path.join(BASE_DIR, "aj-green_basic_stats.xlsx")
    ...
    ranking_csv_filename = os.path.join(BASE_DIR, "aj-green_ranking_stats.csv")
    ranking_df.to_csv(ranking_csv_filename, index=False)
    print(f"Ranking Stats CSV file saved: {ranking_csv_filename}")
    
    ranking_excel_filename = os.path.join(BASE_DIR, "aj-green_ranking_stats.xlsx")
