...
BASE_DIR = "/Users/kamahl/Sports/scripts/nba/teamrankings/players/player_stats/nba_teams/detroit-pistons/tobias-harris"
...
def fetch_and_save_tobias_harris_stats():
    """Fetch and save stats for Tobias Harris from TeamRankings."""
    player_name = "Tobias Harris"
    formatted_name = "tobias-harris"
    ...
    basic_csv_filename = os.path.join(BASE_DIR, "tobias-harris_basic_stats.csv")
    basic_df.to_csv(basic_csv_filename, index=False)
    print(f"Basic Stats CSV file saved: {basic_csv_filename}")
    
    basic_excel_filename = os.path.join(BASE_DIR, "tobias-harris_basic_stats.xlsx")
    ...
    ranking_csv_filename = os.path.join(BASE_DIR, "tobias-harris_ranking_stats.csv")
    ranking_df.to_csv(ranking_csv_filename, index=False)
    print(f"Ranking Stats CSV file saved: {ranking_csv_filename}")
    
    ranking_excel_filename = os.path.join(BASE_DIR, "tobias-harris_ranking_stats.xlsx")
...
if __name__ == "__main__":
    fetch_and_save_tobias_harris_stats()