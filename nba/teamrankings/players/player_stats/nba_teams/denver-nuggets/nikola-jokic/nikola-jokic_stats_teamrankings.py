...
BASE_DIR = "/Users/kamahl/Sports/scripts/nba/teamrankings/players/player_stats/nba_teams/denver-nuggets/nikola-jokic"
...
def fetch_and_save_nikola_jokic_stats():
    """Fetch and save stats for Nikola Jokic from TeamRankings."""
    player_name = "Nikola Jokic"
    formatted_name = "nikola-jokic"
    ...
    basic_csv_filename = os.path.join(BASE_DIR, "nikola-jokic_basic_stats.csv")
    basic_df.to_csv(basic_csv_filename, index=False)
    print(f"Basic Stats CSV file saved: {basic_csv_filename}")
    
    basic_excel_filename = os.path.join(BASE_DIR, "nikola-jokic_basic_stats.xlsx")
    ...
    ranking_csv_filename = os.path.join(BASE_DIR, "nikola-jokic_ranking_stats.csv")
    ranking_df.to_csv(ranking_csv_filename, index=False)
    print(f"Ranking Stats CSV file saved: {ranking_csv_filename}")
    
    ranking_excel_filename = os.path.join(BASE_DIR, "nikola-jokic_ranking_stats.xlsx")
...
if __name__ == "__main__":
    fetch_and_save_nikola_jokic_stats()