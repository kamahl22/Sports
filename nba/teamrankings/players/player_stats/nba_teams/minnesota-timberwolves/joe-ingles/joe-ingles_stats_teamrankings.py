...
BASE_DIR = "/Users/kamahl/Sports/scripts/nba/teamrankings/players/player_stats/nba_teams/minnesota-timberwolves/joe-ingles"
...
def fetch_and_save_joe_ingles_stats():
    """Fetch and save stats for Joe Ingles from TeamRankings."""
    player_name = "Joe Ingles"
    formatted_name = "joe-ingles"
    ...
    basic_csv_filename = os.path.join(BASE_DIR, "joe-ingles_basic_stats.csv")
    basic_df.to_csv(basic_csv_filename, index=False)
    print(f"Basic Stats CSV file saved: {basic_csv_filename}")
    
    basic_excel_filename = os.path.join(BASE_DIR, "joe-ingles_basic_stats.xlsx")
    ...
    ranking_csv_filename = os.path.join(BASE_DIR, "joe-ingles_ranking_stats.csv")
    ranking_df.to_csv(ranking_csv_filename, index=False)
    print(f"Ranking Stats CSV file saved: {ranking_csv_filename}")
    
    ranking_excel_filename = os.path.join(BASE_DIR, "joe-ingles_ranking_stats.xlsx")
...
if __name__ == "__main__":
    fetch_and_save_joe_ingles_stats()