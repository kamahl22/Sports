...
BASE_DIR = "/Users/kamahl/Sports/scripts/nba/teamrankings/players/player_stats/nba_teams/sacramento-kings/alex-len"
...
def fetch_and_save_alex_len_stats():
    """Fetch and save stats for Alex Len from TeamRankings."""
    player_name = "Alex Len"
    formatted_name = "alex-len"
    ...
    basic_csv_filename = os.path.join(BASE_DIR, "alex-len_basic_stats.csv")
    basic_df.to_csv(basic_csv_filename, index=False)
    print(f"Basic Stats CSV file saved: {basic_csv_filename}")
    
    basic_excel_filename = os.path.join(BASE_DIR, "alex-len_basic_stats.xlsx")
    ...
    ranking_csv_filename = os.path.join(BASE_DIR, "alex-len_ranking_stats.csv")
    ranking_df.to_csv(ranking_csv_filename, index=False)
    print(f"Ranking Stats CSV file saved: {ranking_csv_filename}")
    
    ranking_excel_filename = os.path.join(BASE_DIR, "alex-len_ranking_stats.xlsx")
