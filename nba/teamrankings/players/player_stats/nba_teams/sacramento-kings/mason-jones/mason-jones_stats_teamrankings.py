...
BASE_DIR = "/Users/kamahl/Sports/scripts/nba/teamrankings/players/player_stats/nba_teams/sacramento-kings/mason-jones"
...
def fetch_and_save_mason_jones_stats():
    """Fetch and save stats for Mason Jones from TeamRankings."""
    player_name = "Mason Jones"
    formatted_name = "mason-jones"
    ...
    basic_csv_filename = os.path.join(BASE_DIR, "mason-jones_basic_stats.csv")
    basic_df.to_csv(basic_csv_filename, index=False)
    print(f"Basic Stats CSV file saved: {basic_csv_filename}")
    
    basic_excel_filename = os.path.join(BASE_DIR, "mason-jones_basic_stats.xlsx")
    ...
    ranking_csv_filename = os.path.join(BASE_DIR, "mason-jones_ranking_stats.csv")
    ranking_df.to_csv(ranking_csv_filename, index=False)
    print(f"Ranking Stats CSV file saved: {ranking_csv_filename}")
    
    ranking_excel_filename = os.path.join(BASE_DIR, "mason-jones_ranking_stats.xlsx")
...
if __name__ == "__main__":
    fetch_and_save_mason_jones_stats()