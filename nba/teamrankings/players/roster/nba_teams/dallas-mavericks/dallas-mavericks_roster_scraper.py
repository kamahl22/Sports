...
BASE_DIR = "/Users/kamahl/Sports/scripts/nba/teamrankings/players/roster/nba_teams/dallas-mavericks"
os.makedirs(BASE_DIR, exist_ok=True)

def fetch_and_save_dallas_mavericks_roster():
    """Fetch and save the Dallas Mavericks roster from TeamRankings."""
    url = "https://www.teamrankings.com/nba/team/dallas-mavericks/roster"
    
    print(f"Fetching roster for Dallas Mavericks from {url}")
    ...
    # Save to CSV
    csv_filename = os.path.join(BASE_DIR, "dallas-mavericks_roster.csv")
    df.to_csv(csv_filename, index=False)
    print(f"CSV file saved: {csv_filename}")
    
    # Save to Excel
    excel_filename = os.path.join(BASE_DIR, "dallas-mavericks_roster.xlsx")
    df.to_excel(excel_filename, index=False)
    print(f"Excel file saved: {excel_filename}")
    
    # Print formatted table to terminal
    print(f"\nRoster for Dallas Mavericks")
...
if __name__ == "__main__":
    fetch_and_save_dallas_mavericks_roster()