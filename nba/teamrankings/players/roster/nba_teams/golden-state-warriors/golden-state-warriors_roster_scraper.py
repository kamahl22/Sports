...
BASE_DIR = "/Users/kamahl/Sports/scripts/nba/teamrankings/players/roster/nba_teams/golden-state-warriors"
os.makedirs(BASE_DIR, exist_ok=True)

def fetch_and_save_golden_state_warriors_roster():
    """Fetch and save the Golden State Warriors roster from TeamRankings."""
    url = "https://www.teamrankings.com/nba/team/golden-state-warriors/roster"
    
    print(f"Fetching roster for Golden State Warriors from {url}")
    ...
    # Save to CSV
    csv_filename = os.path.join(BASE_DIR, "golden-state-warriors_roster.csv")
    df.to_csv(csv_filename, index=False)
    print(f"CSV file saved: {csv_filename}")
    
    # Save to Excel
    excel_filename = os.path.join(BASE_DIR, "golden-state-warriors_roster.xlsx")
...
if __name__ == "__main__":
    fetch_and_save_golden_state_warriors_roster()