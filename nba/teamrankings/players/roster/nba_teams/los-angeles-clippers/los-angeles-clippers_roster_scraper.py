...
BASE_DIR = "/Users/kamahl/Sports/scripts/nba/teamrankings/players/roster/nba_teams/los-angeles-clippers"
os.makedirs(BASE_DIR, exist_ok=True)

def fetch_and_save_los_angeles_clippers_roster():
    """Fetch and save the Los Angeles Clippers roster from TeamRankings."""
    url = "https://www.teamrankings.com/nba/team/los-angeles-clippers/roster"
    
    print(f"Fetching roster for Los Angeles Clippers from {url}")
    ...
    # Save to CSV
    csv_filename = os.path.join(BASE_DIR, "los-angeles-clippers_roster.csv")
    df.to_csv(csv_filename, index=False)
    print(f"CSV file saved: {csv_filename}")
    
    # Save to Excel
    excel_filename = os.path.join(BASE_DIR, "los-angeles-clippers_roster.xlsx")
    df.to_excel(excel_filename, index=False)
    print(f"Excel file saved: {excel_filename}")
    
    # Print formatted table to terminal
    print(f"\nRoster for Los Angeles Clippers")
...
if __name__ == "__main__":
    fetch_and_save_los_angeles_clippers_roster()