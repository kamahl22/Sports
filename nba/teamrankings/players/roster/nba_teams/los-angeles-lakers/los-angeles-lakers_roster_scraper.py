...
BASE_DIR = "/Users/kamahl/Sports/scripts/nba/teamrankings/players/roster/nba_teams/los-angeles-lakers"
os.makedirs(BASE_DIR, exist_ok=True)

def fetch_and_save_los_angeles_lakers_roster():
    """Fetch and save the Los Angeles Lakers roster from TeamRankings."""
    url = "https://www.teamrankings.com/nba/team/los-angeles-lakers/roster"
    
    print(f"Fetching roster for Los Angeles Lakers from {url}")
    ...
    # Save to CSV
    csv_filename = os.path.join(BASE_DIR, "los-angeles-lakers_roster.csv")
    df.to_csv(csv_filename, index=False)
    print(f"CSV file saved: {csv_filename}")
    
    # Save to Excel
    excel_filename = os.path.join(BASE_DIR, "los-angeles-lakers_roster.xlsx")
...
if __name__ == "__main__":
    fetch_and_save_los_angeles_lakers_roster()