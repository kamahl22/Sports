...
def fetch_and_save_detroit_pistons_ats_trends():
    """Fetch, save, and print the Detroit Pistons ATS trends from TeamRankings."""
    url = "https://www.teamrankings.com/nba/team/detroit-pistons/ats-trends"
    
    print(f"Fetching ATS trends for Detroit Pistons from {url}")
    ...
    csv_filename = os.path.join(BASE_DIR, team_name_lower, "detroit-pistons_ats_trends.csv")
    os.makedirs(os.path.dirname(csv_filename), exist_ok=True)
    df.to_csv(csv_filename, index=False)
    print(f"CSV file saved: {csv_filename}")
    
    # Save to Excel
    excel_filename = os.path.join(BASE_DIR, team_name_lower, "detroit-pistons_ats_trends.xlsx")
    df.to_excel(excel_filename, index=False)
    print(f"Excel file saved: {excel_filename}")
    
    # Print formatted table
    print(f"\nATS Trends for Detroit Pistons")
...
if __name__ == "__main__":
    fetch_and_save_detroit_pistons_ats_trends()
