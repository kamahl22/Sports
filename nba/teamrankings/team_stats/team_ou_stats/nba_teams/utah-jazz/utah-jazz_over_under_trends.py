...
def fetch_and_save_utah_jazz_over_under_trends():
    """Fetch, save, and print the Utah Jazz Over/Under trends from TeamRankings."""
    url = "https://www.teamrankings.com/nba/team/utah-jazz/over-under-trends"
    
    print(f"Fetching Over/Under trends for Utah Jazz from {url}")
    ...
    csv_filename = os.path.join(BASE_DIR, team_name_lower, "utah-jazz_over_under_trends.csv")
    os.makedirs(os.path.dirname(csv_filename), exist_ok=True)
    df.to_csv(csv_filename, index=False)
    print(f"CSV file saved: {csv_filename}")
    
    # Save to Excel
    excel_filename = os.path.join(BASE_DIR, team_name_lower, "utah-jazz_over_under_trends.xlsx")
...
if __name__ == "__main__":
    fetch_and_save_utah_jazz_over_under_trends()
