...
def fetch_and_save_gamelog():
    ...
    player_folder = os.path.join(base_dir, "houston-rockets", "nate_williams")
    os.makedirs(player_folder, exist_ok=True)
    csv_filename = os.path.join(player_folder, "nate_williams_gamelog.csv")
